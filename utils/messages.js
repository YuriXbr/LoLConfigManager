...
ptBR = {
    ...
    gitHubRateLimit: 'Não foi possivel receber informações sobre atualizações no momento.',
    ...
    menuOp5:'  [5] Reiniciar o explorer                |  (Reinicia o explorer e a barra de tarefas)',
    menuOpX:'\n  [X] Configurações',
    menuOpC:'  [CTRL+C] Sair',
    menuOutput: "\nOUTPUT:",
    ...
    restartedExplorer: "Explorer Reiniciado.",
    lowerPriorityLabel: '\nPrioridade do processo:',
    lowerPriorityRealTime: "  [1] Tempo real      (Mais alto)",
    lowerPriorityHigh: "  [2] Alto            (Alto)",
    lowerPriorityAboveNormal: "  [3] Acima do normal",
    lowerPriorityNormal: "  [4] NORMAL          (Padrão)",
    lowerPriorityBelowNormal: "  [5] Abaixo do normal",
    lowerPriorityLower: "  [6] Baixo           (Menor possivel)",
    lowerPriorityExit: " [7/X] Sair",
    lowerPriorityQuestion: '\n » Por favor, digite o número da opção de prioridade: ',
    lowerPriorityORealTime: `Processo do LeagueUxRender colocado em tempo real.`,
    lowerPriorityOHigh: `Processo do LeagueUxRender colocado em Alto.`,
    lowerPriorityOAboveNormal: `Processo do LeagueUxRender colocado em Acima do normal.`,
    lowerPriorityONormal: `Processo do LeagueUxRender de volta a prioridade normal.`,
    lowerPriorityOBelowNormal: `Processo do LeagueUxRender colocado abaixo do normal.`,
    lowerPriorityOLower: `Processo do LeagueUxRender colocado em baixa prioridade`,
    openLeaguePathSuccess: 'Pasta do LeaguePath aberta com sucesso!',
    openLeaguePathError: '[ERROR] Ocorreu um erro ao abrir a pasta do LeaguePath: ',
    openLeaguePathNotConfigured: '[ALERTA] O LeaguePath ainda não está configurado! Por favor, configure-o primeiro.',
}
